...
Model.load(model_name, min_diff=0.00001, learning_rate=0.000001, cycles=1000, ignore_minimum=1, activation_values=[4,4,4,100], hidden_shaped=False, normaliser_depth=0)
