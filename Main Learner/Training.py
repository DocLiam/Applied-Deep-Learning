...
Model.load(model_name, min_diff=0.1, learning_rate=0.0000001, cycles=2000, ignore_minimum=1, activation_values=[4,4,4,100], hidden_shaped=False, normaliser_depth=0)
